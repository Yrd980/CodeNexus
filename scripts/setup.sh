...
echo "  • Edit repo queue:    \$EDITOR MANUAL_REPO_QUEUE.md"
echo "  • Run repo queue:     python scripts/openclaw_repo_queue_pipeline.py"
echo "  • Run one batch:      python scripts/openclaw_long_run.py --max-batches 1 --sleep-seconds 0"
echo "  • Runtime truth:      python scripts/openclaw_runtime_verifier.py --manifest runtime/openclaw/latest-manifest.json --runtime-root runtime/openclaw --output runtime/openclaw/latest-runtime-verification.json"
echo "  • Run forever:        python scripts/openclaw_long_run.py --forever --sleep-seconds 900"
echo "  • Watchdog mode:      python scripts/openclaw_watchdog.py --runtime-root runtime/openclaw-live --sleep-seconds 600"
